...
const HireMe = () => {
    return (
        <div className='fixed left-4 bottom-6
        ...
        '>
            <div className='w-48 h-auto flex items-center justify-center relative md:w-24'>
                <CircularText className={"fill-dark animate-spin-slow dark:fill-white"} />

                <Link href="mailto:alarosai@Simon.rochester.edu" className='flex items-center justify-center
